...
import { relations } from "drizzle-orm"; // Tambahkan import ini
...
export const users = pgTable('users', {
    ...
    birth_date: date('birth_date'), // Tanggal lahir user
...
export const training_sessions = pgTable('training_sessions', {
    ...
    location_id: integer('location_id').references(() => training_locations.id), // Tambahkan .references di sini
    // Tidak ada commander_id tunggal lagi!
});

export const training_sessions_relations = relations(training_sessions, ({ one }) => ({
    location: one(training_locations, {
        fields: [training_sessions.location_id],
